...
namespace TestUnium.Tests.Stepping.Validation
{
    public class RequiredMembersStepValidatorTests
    {
        ...
        public void Required_Members_Step_Validator_Perfomance_Tests()
        {
            ...
            {
                stepRunner.Run(null, String.Empty, step, null, StepExceptionHandlingMode.Rethrow, false);
            }
            stopwatch.Stop();
            ...
            for (var i = 0; i < creationAttemptsNumber; i++)
            {
                stepRunner.Run(null, String.Empty, step, null, StepExceptionHandlingMode.Rethrow, true);
            }
            stopwatch.Stop();
